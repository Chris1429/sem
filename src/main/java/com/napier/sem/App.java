...
public class App {
    public static void main(String[] args) {
        ...
        ArrayList<Employee> employees = a.salariesByDepartment();
    ...
    public Employee getEmployee(int ID) {
        try {
            ...
            if (rset.next()) {
                ...
                //Change this code to call getDepartment method then store it in emp.dept
    ...
    public ArrayList<Employee> salariesByDepartment() {
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();
            // Create string for SQL statement
